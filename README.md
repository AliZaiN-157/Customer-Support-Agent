...
- 📦 **Order Status Lookup** - Query order details by Order ID
- 👤 **Customer Order History** - Find all orders for a specific customer by email
...
│   ├── __init__.py
│   ├── agent.py                 # Main agent definition and CLI
